...
export default function PaymentCredito({ item, settype, }) {
    ...
    return (
        <Column >
            ...
            <Label style={{ fontSize: 16, lineHeight: 16, marginBottom: 24, marginTop: 8, textAlign: 'center', fontFamily: 'Font_Medium', }}>Preencha os para prosseguir</Label>

            <Row style={{ justifyContent: 'space-between', alignItems: 'center', }}>
                <Row>
                    <Column style={{ paddingVertical: 12, paddingHorizontal: 12, backgroundColor: color.blue + 20, borderRadius: 12, }}>
                        <CreditCard size={24} color={color.blue} />
                    </Column>
                ...
                <Button onPress={() => { settype() }} style={{ width: 42, height: 42, borderRadius: 100, justifyContent: 'center', alignItems: 'center', }}>
                    <X color={color.secundary} size={22} />
                </Button>
            </Row>

            <Column style={{ marginTop: 12, }}>
                <Column style={{ backgroundColor: color.blue, borderRadius: 8, flexGrow: 1, paddingVertical: 16, paddingHorizontal: 16, }}>
            ...
            <Column>
                <Row style={{ borderRadius: 8, marginTop: 24, borderWidth: 2, borderColor: focusNome ? color.primary : color.border, }}>
                ...
                <Row style={{ borderRadius: 8, marginTop: 12, borderWidth: 2, borderColor: focusNumerocartao ? color.primary : color.border, }}>
                    <Column style={{ justifyContent: 'center', width: 52, height: 52, alignItems: 'center', borderRadius: 100, }}>
                ...
                <Row style={{ justifyContent: 'space-between', alignItems: 'center', }}>
                    <Row style={{ borderRadius: 8, marginTop: 12, borderWidth: 2, borderColor: focusCvv ? color.primary : color.border, width: '42%', }}>
                        <Column style={{ justifyContent: 'center', width: 52, height: 52, alignItems: 'center', borderRadius: 100, }}>
                    ...
                    <Row style={{ borderRadius: 8, marginTop: 12, borderWidth: 2, borderColor: focusMes ? color.primary : color.border, width: '52%', }}>
                        <Column style={{ justifyContent: 'center', width: 52, height: 52, alignItems: 'center', borderRadius: 100, }}>
