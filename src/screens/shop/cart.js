                    ...
                    <FlatList
                        ...
                        ListEmptyComponent={
                            <Column style={{ backgroundColor: '#fff', }}>
                                <Row style={{ marginTop: -8, zIndex: 99, marginHorizontal: -6, justifyContent: 'space-between', alignItems: 'center', }}>
                                    <Column style={{ width: 24, height: 24, borderRadius: 100, backgroundColor: color.bg, }}></Column>
                                    <Column style={{ width: 24, height: 24, borderRadius: 100, backgroundColor: color.bg, }}></Column>
                                </Row>
                                <Column style={{ justifyContent: 'center', alignItems: 'center', }}>
                                    <Column style={{ height: 12 }} />
                                    <ShoppingCart color={color.sc.sc3} size={42} />
                                ...
                                <Row style={{ marginBottom: -8, zIndex: 99, marginHorizontal: -6, justifyContent: 'space-between', alignItems: 'center', }}>
                                    <Column style={{ width: 24, height: 24, borderRadius: 100, backgroundColor: color.bg, }}></Column>
                                    <Column style={{ width: 24, height: 24, borderRadius: 100, backgroundColor: color.bg, }}></Column>
                                </Row>
                            </Column>
